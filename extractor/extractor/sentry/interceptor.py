"""
This is code written by temporal that enables sentry in the temporal worker.
https://github.com/temporalio/samples-python/blob/a0b2cdf4b0eef905776fba9b1a2805357b8b473e/sentry/interceptor.py
"""
        ...
        with isolation_scope():
            ...
            try:
                ...
                if len(input.args) == 1 and is_dataclass(input.args[0]):
                    set_context("temporal.activity.input", asdict(input.args[0]))  # type: ignore
    ...
    async def execute_workflow(self, input: ExecuteWorkflowInput) -> Any:
        ...
        with isolation_scope():
            ...
            try:
                ...
                if len(input.args) == 1 and is_dataclass(input.args[0]):
                    set_context("temporal.workflow.input", asdict(input.args[0]))  # type: ignore
