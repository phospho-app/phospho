...
if ENVIRONMENT == "production":
    PRO_PLAN_STRIPE_PRICE_ID = "price_1PBK2YKMbS7I1rNcm32fIlIe"
else:
    PRO_PLAN_STRIPE_PRICE_ID = "price_1PBBh3KMbS7I1rNcxK6TTATb"

if ENVIRONMENT == "production":
    PRO_PLAN_STRIPE_PRODUCT_ID = "prod_Q1MmzyS5iPe70w"
else:
    PRO_PLAN_STRIPE_PRODUCT_ID = "prod_Q1E95zTaBBXzcs"
