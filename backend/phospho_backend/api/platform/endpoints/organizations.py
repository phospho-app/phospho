...
from phospho_backend.services.mongo.emails import (
    email_user_onboarding,
    send_payment_issue_email,
)
from phospho_backend.services.mongo.organizations import (
...
async def get_org_number_users(
    ...
    org_member_info = propelauth.require_org_member(user, org_id)
    org_metadata = org_member_info.org_metadata or {}

    user_paged_response = propelauth.fetch_users_in_org(org_id)
    total_users = user_paged_response.total_users
